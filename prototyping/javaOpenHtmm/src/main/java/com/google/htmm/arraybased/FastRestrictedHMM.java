...
void ForwardBackward(double epsilon,
                                        double[] theta,
                                        double[][] local,
                                        double[] pi,
                                        double[][] sprobs,
...
void InitAlpha(double[] pi,
                                  double[] local0,
                                  double norm, double[] alpha0) {
  norm = 0;
...
void ComputeAllAlphas(double[][] local,
                                         double[] theta,
                                         double epsilon,
                                         double[] norm_factor,
                                         double[][] alpha) {
...
void ComputeSingleAlpha(double[] local_t,
                                           double[] theta,
...
// advantage of the special structure of our problem!
void ComputeAllBetas(double[][] local,
                                        double[] theta,
                                        double epsilon,
                                        double[] norm_factor,
                                        double[][] beta) {
...
void ComputeSingleBeta(double[] local_t_1,
                                          double[] theta,
                                          double epsilon, double norm,
                                          double[] beta_t1,
                                          double[] beta_t) {
...
void CombineAllProbs(double[][] alpha,
                                        double[][] beta,
                                        double[][] sprobs) {
...
// single level.
void CombineSingleProb(double[] alpha,
                                          double[] beta,
                                          double[] sprobs) {
  double norm = 0;
...
// factors.
double ComputeLoglik(double[] norm_factor,
                                      double loglik) {
  loglik = 0;
